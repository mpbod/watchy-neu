...
static void draw_grid03(watchy_canvas_t *canvas, void *user_data,
    ...
    watchy_text_style_t value = grid_modular_value_style();
    ...
    grid_draw_text_fit_centered(canvas, 100, 98, local.c_str(), large, 190u);
    ...
    watchy_ui_draw_text_font(canvas, 9, 141, format_weekday(time).c_str(), &small);
    watchy_ui_draw_text_font(canvas, 9, 174, day, &day_style);
    watchy_ui_draw_text_font(canvas, 9, 194, month, &small);
    watchy_ui_draw_text_font(canvas, 75, 141, "OUT", &small);
    grid_draw_text_fit_centered(canvas, 100, 171, kTemperature, value, 49u);
    watchy_ui_draw_text_font(canvas, 75, 194, kNoData, &small);
    watchy_ui_draw_text_font(canvas, 142, 141, "TYO", &small);
    grid_draw_text_fit_centered(canvas, 167, 171, tokyo_clock.c_str(), value, 49u);
    (void)user_data;
}
}
