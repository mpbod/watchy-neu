...
- all three Menu selections, 1px row-bottom borders, rail separators, exact triangle and thumb endpoint geometry, label regions, selected-row inversion, face-icon stem/no-horizontal-hand pixels, and the diamond center pixel;
