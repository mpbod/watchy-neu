...
#define WATCHY_SHELL_ACTION_SELECT_BUILTIN \
    ((watchy_shell_action_t)(WATCHY_SHELL_ACTION_NORMAL_REBOOT + 1))
#define WATCHY_SHELL_ACTION_SELECT_WATCHFACE \
    ((watchy_shell_action_t)(WATCHY_SHELL_ACTION_NORMAL_REBOOT + 2))
