...
static void render_hairline(watchy_canvas_t *canvas, const watchy_time_t *time,
    ...
    draw_centered_date(canvas, &watchy_font_plex_10_semibold, time, 176);
